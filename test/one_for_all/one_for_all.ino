    ...
    else if(event == ESP_SPP_DATA_IND_EVT)  //数据接收标志
    {
       ...
       if(mark == 1)  
       {
         ...
         for(int i = 0; i < comdata.length() ; i++)
         {
          ...
          Serial.write("收到数据为:");
          Serial.write(numdata[0]);
          Serial.write(numdata[1]);
          Serial.write(numdata[2]);
          Serial.write(numdata[3]);
